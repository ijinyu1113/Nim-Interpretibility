...
if len(sys.argv) < 2:
    raise SystemExit("usage: python test_model_maxrem.py <subdir>")
SUBDIR = sys.argv[1]

ckpt_root = "/work/hdd/benv/shared/345678-finetuned" + "/" + SUBDIR
eval_file = "345678_train_10k.jsonl"
max_examples = None
...
for ckpt_path in checkpoints:
    ...
    out_file = f"345678_train_errs_{name}.jsonl"
