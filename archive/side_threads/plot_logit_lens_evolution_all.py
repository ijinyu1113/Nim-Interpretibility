"""Build the 3 x N logit-lens evolution figure across ALL training checkpoints.

Same as plot_logit_lens_evolution.py, but plots every available ckpt-* dir
(STEPS_SUBSET = None) and writes to a separate output path.
"""
import glob
import os
import re
